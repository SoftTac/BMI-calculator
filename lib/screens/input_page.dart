...
class _InputPageState extends State<InputPage> {
  // Initialize selectedGender with a default value
  Gender selectedGender = Gender.male;  // Default gender selected as male
  int height = 180;
  int weight = 60;
  int age = 20;
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            // Third Row: Weight and Age Selection
            Row(
              children: <Widget>[
                Expanded(
                  //flex: 1,
